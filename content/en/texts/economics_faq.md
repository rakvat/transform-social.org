Slug: economics_faq
Date: 2024/1/1
Title: FAQ on Anarchist Economics
Author: Katja
Type: text
Tags: Economics, Anarchism
Summary: TODO
Catchphrases: TODO | TODO | TODO

# FAQ on Anarchist Economics

Frequently asked questions (FAQ) about anarchist economics and their answers. The following focuses on the anarcho-communist flavor of anarchism. The answers are the author's opinion and don't represent the ideas of any organization.

This is intentionally kept short and concise.
...
The capitalist version of an economy is quite unpredictable, fragile, and very complex. Many small things could lead to a huge crisis and politicians thus fear making major changes. Fragile and crashing economies are prone to cause famines and even deaths. Yes, modern production and distribution have quite some complexity due to dependencies. However, the complexity and fagility can be reduced by methods of decentralization and encapsulation, allowing everyone to understand the relevant parts of economics. This will be further explained below.

## Isn't economics something for experts?
...
Yes. The questions and answers below will explain further how.

## Why is this FAQ written from an anarcho-communist viewpoint?

Anarcho-communism is the flavor of anarchist economics that I like best because maximizes both freedom and solidarity. It uses no market and no wage labor (see below for the issues I see with those) and distributes based on need. If you prefer other types of economics, that's fine, you can write another FAQ. Under certain conditions, there is a good chance that diverse forms of economics can coexist (see below).
...
* freedom also means having the security that our needs will also be fulfilled tomorrow and in the future
...
## Why is hoarding not a problem in anarchist economies?
...
Those affected by the decisions should be able to be part of the decisions. They don't have to decide everything as they could also trust others to make the right decisions but they could if they wanted. To make this possible, it's important that upcoming decisions and the related background information are transparently accessible to everyone who is affected.

## What is an anarchist critizism of the current economy?
...
3. Production under capitalism focuses on profit, not on needs of the people. Capitalism is causing huge social injustices and wars. This and the structures of dominance have a huge negative impact on both the physical and psychological health of many humans.


## How is the anarchist criticism of capitalism different from the marxist criticism?

Marxism mostly focuses on the exploitation of workers. Not all marxists are critical towards power exercised by an elite or a state. Anarchist identify all forms of dominance and want to abolish them all.

## Will there be only one type of anarchist economy? Is there a blueprint?
...
## What are the advantages of plans?
...
## Are wages for labor really a good idea?

No, any wage for labor (no matter if it's money or tokens representing work hours or something similar) has negative effects:

1. No matter if the wage is calculated depending on education, experience, hours, or effort - there can never be a concept that is fair to everyone.
...
## Will we have to work long hours?

No, we will probably have to work less than today, because many jobs like those in the financial sector, insurance, or advertisement won't be needed anymore. Others could be simplified because information about production processes could be open so research does not have to be duplicated. The amount of necessary work depends both on the needs and decisions of the community you live in and on the extent of environmental damage that will need effort for restoration.
...
The producers decide how to produce as long as this decision does not affect others. E.g. if the chosen method of production has a negative impact on the environment or uses scarce resources, others affected by this decision should be involved.
...
No. It's okay to commit to one type of work for a whole life if that's what you enjoy. However, if you do a very well-liked job, the community might ask you to also work some hours on less popular work. It's also okay, to switch jobs often or to work on multiple things at the same time. Some work types require intensive training. Volunteers for this kind of work will be asked to commit to the work for a longer time period.
...
## What if someone does not contribute anything and uses a lot of resources?
...
## Would anarchist economies be only local or could we have e.g. coffee?
...
Yes. It just needs to be fairly distributed.

## Aren't there too many decisions?
...
## I still don't understand. What would a day in an anarchist economy look like?
...
Capitalism uses the market price as a universal unit of account. Other socialist economies suggest tokens based on work hours. Anarchist economies as envisioned by this FAQ don't need a universal unit of account. In some cases, relevant key figures are useful (e.g. the usage of scarce resources). However, the type of key figures needed depends on the context. Key figures are more useful and informative than a universal unit of account.

## Why is money (or tokens, or any universal unit of account) problematic?

Universal units of account reduce the information of a product or service to one number. They also suggest the idea of being able to exchange one thing with another with the name number and the idea of wanting to increase the collection of amounts of the universal unit of account. This distracts from the main purpose of an economy: the fulfillment of needs.

## Should anarchist economics account for the needs of future generations?
...
## What is the difference to a surveillance state?
...
## Will trade always exist?

Anarchist economics will not prohibit trade as there is no central authority to enforce rules but the goal of needs-based economies should be to make trade unnecessary and thus irrelevant as everyone should be able to get what they need without having to engage in trade.

## How is innovation possible?

Due to the fact that people will work only a few hours per day, there will be more leisure time for inspiration. Also, information about innovative ideas could be freely changed in the information system, as they can't be used for profit any more, sparking new ideas and cooperation.
...
## Can an anarchist economy only exist if the whole planet switches to it?
...
As capitalism is inherently expansive, wanting to grow all the time, there is a danger that neighboring capitalist areas could try to exploit, bring important resources forcefully under their control, or even overthrow anarchist economies. (See above about how to avoid military aggressions.) Peaceful coexistence with capitalism can be possible if everyone respects the agreements and conditions for the coexistence (see below).

## Under which conditions could diverse forms of economies coexist?
...
## Wouldn't the economy crash if we tried anarchist economics?
...
## Some socialists and some climate activists claim that the immediate danger of the climate crisis requires a timely system change or revolution with a strong leader. Why do anarchists disagree?

Climate change is real and to prevent the worst, urgent action is required. On the other hand, the pressure to act quickly can be used by authoritarians as a justification to install a strong state. Either to enforce climate change countermeasures with authoritarian or even military measures or to fight those who want to do that. Either way, authoritarian states were never a good idea: Many people have been killed and tortured by both communist- and national-socialist authoritarian states in the past. I'd rather have a slower transformation while handling the environmental damage in solidarity, than an authoritarian dictatorship.
...
## You are making all of this up, anarchist economies can't really work, or can they?

Versions of anarchist economics worked during the Spanish Civil War in 1936-1939. Versions of it work in smaller communities today, and also in your friends group (you are not expecting something in return when you help a friend). Also, research and simulations show that anarchist economies will work.

## How could we get into anarchist economies?

We can share information about the feasibility of anarchist economies and thus change the narrative of there being only one economic possibility. We can start building structures of anarchist economies within the old system (as good as possible without getting frustrated). This is called prefigurative politics and allows us to experiment with and practice capabilities useful in anarchist societies while building infrastructure that is useful now as well as in the anarchist future. We can also start making more plans for the future anarchist economies, either as role play or more seriously: Which production facilities could be reused, and which are useless? What are the most important elements of the infrastructure to fulfill the needs? What would you work on during and after the transformation? Let's build many anarchist economics oases, bridges, and networks within the capitalist desert until the wildflowers start growing all over.
